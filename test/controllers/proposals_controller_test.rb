...
class ProposalsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create proposal" do
    assert_difference('Proposal.count') do
      post proposals_url, params: { proposal: { congressman_id: @proposal.congressman_id, count: @proposal.count, key_word: @proposal.key_word } }
    end
  ...
  test "should update proposal" do
    patch proposal_url(@proposal), params: { proposal: { congressman_id: @proposal.congressman_id, count: @proposal.count, key_word: @proposal.key_word } }
